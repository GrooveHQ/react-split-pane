...
class SplitPane extends React.Component {
  ...
  setRealSize = size => {
    if (this.state.draggedSize === size) return;
  ...
  render() {
    ...
    const resizerClassNamesIncludingDefault = resizerClassName
      ? `${resizerClassName} ${this.classNameWithState(
          resizerClassName
        )} ${RESIZER_DEFAULT_CLASSNAME} ${this.classNameWithState(
